      ...
      <nav className="main-nav">
        <div className="container mx-auto px-4">
          <div className="h-16 flex items-center justify-between">
            ...
            >
              {['Menú', 'Nosotros', 'Contacto', 'QR'].map((item) => (
                <button
                  key={item}
          ...
          <div className="hero-content grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="absolute inset-0 bg-neutral-800">
                {/* Aquí va la imagen - className="w-full h-full object-cover" */}
      ...
      <footer className="footer-section">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            >
              <h3 className="text-lg font-semibold text-white">
                Suscríbete a nuestros beneficios
              </h3>
              <div className="relative">
                <input
                  type="email"
                  placeholder="Ingresa tu email"
                  className="bg-white text-gray-300 px-4 py-2 pr-32 rounded-lg 
                    w-full md:w-[350px] focus:outline-none focus:ring-2 focus:ring-red-500
                    border border-neutral-800"
                />
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="absolute right-2 top-1/2 -translate-y-1/2 bg-red-500 
                    hover:bg-red-600 text-white px-4 py-1 rounded
          ...
          <div className="mt-12 pt-8 border-t border-neutral-800 text-center text-gray-500 text-sm">
            © {new Date().getFullYear()} Supported by COMIREST
          </div>
        </div>
      </footer>
    </div>
